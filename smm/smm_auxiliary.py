...
def update_optim_paras(init_file_name, optim_paras):
    ...
    init_dict["PARAMETERS"]["const_p"] = optim_paras.item(12)
    init_dict["PARAMETERS"]["const_f"] = optim_paras.item(13)
    init_dict["PARAMETERS"]["theta_p1"] = optim_paras.item(14)
    init_dict["PARAMETERS"]["theta_f1"] = optim_paras.item(15)
    init_dict["PARAMETERS"]["share_1"] = optim_paras.item(16)
    init_dict["PARAMETERS"]["sigma_1"] = optim_paras.item(17)
    init_dict["PARAMETERS"]["sigma_2"] = optim_paras.item(18)
    init_dict["PARAMETERS"]["sigma_3"] = optim_paras.item(19)
